...
- Rotas:
  ...
  - PATCH /user — atualiza nome/email do usuário
...
| Comunicação via API com alguma LLM | 9 |
| Layout agradável e responsivo com Tailwind | 10 |
...
| Utilizar alguma lib de componentes disponível no directory do ShadcnUI | 4 |
